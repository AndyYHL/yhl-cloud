...
// APP START
// -----------------------------------
var App12 = angular.module('angle', [
    'ngRoute',
    'ngAnimate',
    'ngStorage',
    'ngCookies',
...
App12.run(["$rootScope", "$state", "$stateParams",  '$window','$http', '$templateCache', function ($rootScope, $state, $stateParams, $window, $http, $templateCache) {
...
App12.config(['$controllerProvider', '$compileProvider', '$filterProvider', '$provide',
    function ( $controllerProvider, $compileProvider, $filterProvider, $provide) {
        'use strict';
        // registering components after bootstrap
        App12.controller = $controllerProvider.register;
        App12.directive  = $compileProvider.directive;
        App12.filter     = $filterProvider.register;
        App12.factory    = $provide.factory;
        App12.service    = $provide.service;
        App12.constant   = $provide.constant;
        App12.value      = $provide.value;
        ...
        function ($stateProvider, $locationProvider, $urlRouterProvider, helper) {
            ...
            $stateProvider
                .state('app', {
                    ...
                    resolve: helper.resolveFor('fastclick', 'modernizr','ngDialog', 'icons', 'screenfull', 'animo', 'sparklines', 'slimscroll', 'classyloader', 'toaster', 'whirl','datatables')
                })
                .state('app.home', {
                    url: '/home',
                    title: 'home',
...
App12.controller('LoginFormController', ['$scope', '$http', '$state', function($scope, $http, $state) {
...
App12.controller('RegisterFormController', ['$scope', '$http', '$state', function($scope, $http, $state) {
...
App12.controller('AngularGridController', ['$scope', '$http', function ($scope, $http) {
    'use strict';
...
App12.controller('ArticleController', ['$scope', function ($scope) {
 ...
 */
App12.filter('propsFilter', function() {
...
App12.controller('CalendarController', ['$scope', function($scope) {
    'use strict';
...
App12.controller('AngularCarouselController', ["$scope", function($scope) {
...
App12.controller('ChartJSController', ["$scope", "colors", function($scope, colors) {
...
App12.controller('ChartistController', ['$scope', function ($scope) {
    'use strict';
...
App12.controller('CodeEditorController', ['$scope', '$http', '$ocLazyLoad', function ($scope, $http, $ocLazyLoad) {
...
App12.controller('AlertDemoCtrl', ['$scope', function AlertDemoCtrl($scope) {
...
App12.controller('ButtonsCtrl', ['$scope', function ($scope) {
...
App12.controller('CarouselDemoCtrl', ['$scope', function ($scope) {
...
App12.controller('DatepickerDemoCtrl', ['$scope', function ($scope) {
...
App12.controller('DialogIntroCtrl', ['$scope', 'ngDialog', 'tpl', function($scope, ngDialog, tpl) {
    'user strict';
...
// Loads from view
App12.controller('DialogMainCtrl', ["$scope", "$rootScope", "ngDialog", function ($scope, $rootScope, ngDialog) {
    'user strict';
...
App12.controller('InsideCtrl', ["$scope", "ngDialog", function ($scope, ngDialog) {
    'user strict';
    $scope.dialogModel = {
...
App12.controller('SecondModalCtrl', ["$scope", "ngDialog", function ($scope, ngDialog) {
    'user strict';
...
App12.controller('FormDemoCtrl', ["$scope", "$resource", function($scope, $resource) {
    'use strict';
...
App12.controller('NotifyDemoCtrl', ['$scope', 'Notify', '$timeout', function AlertDemoCtrl($scope, Notify, $timeout) {
...
App12.controller('PaginationDemoCtrl', ['$scope', function ($scope) {
    $scope.totalItems = 64;
    $scope.currentPage = 4;
...
App12.controller('PanelsCtrl', ['$scope', '$timeout', function ($scope, $timeout) {
...
App12.controller('PopoverDemoCtrl', ['$scope', function ($scope) {
...
App12.controller('ProgressDemoCtrl', ['$scope', function ($scope) {
...
App12.controller('RatingDemoCtrl', ['$scope', function ($scope) {
...
App12.controller('TimepickerDemoCtrl', ['$scope', function ($scope) {
...
App12.controller('ToasterDemoCtrl', ['$scope', 'toaster', function($scope, toaster) {
 ...
 * Provides a simple demo for tooltip
 =========================================================*/
App12.controller('TooltipDemoCtrl', ['$scope', function ($scope) {
...
App12.controller('TypeaheadCtrl', ['$scope', '$http', function ($scope, $http) {
...
App12.controller('FlotChartController', ['$scope', 'ChartData', '$timeout', function($scope, ChartData, $timeout) {
    'use strict';
 ...
 * Image crop controller
 =========================================================*/
App12.controller('ImageCropController', ["$scope", function($scope) {
...
App12.controller('FormValidationController', ["$scope", function ($scope) {
    'use strict';
...
App12.controller('FormxEditableController', ['$scope', 'editableOptions', 'editableThemes', '$filter', '$http',
...
App12.controller('ModalGmapController', ['$scope', '$modal', '$timeout', function ($scope, $modal, $timeout) {
...
App12.controller('GMapController', ["$scope", "$timeout", function($scope, $timeout){
...
App12.controller('InfiniteScrollController', ["$scope", "$timeout", function($scope, $timeout) {
...
App12.controller('LocalizationController', ["$rootScope", "tmhDynamicLocale", "$locale", function($rootScope, tmhDynamicLocale, $locale) {
...
App12.controller('MailboxController', ["$scope", "colors", function($scope, colors) {
...
App12.controller('MailFolderController', ['$scope', 'mails', '$stateParams', function($scope, mails, $stateParams) {
    // no filter for inbox
...
App12.controller('MailViewController', ['$scope', 'mails', '$stateParams', function($scope, mails, $stateParams) {
...
App12.factory('mails', ['$http', function ($http) {
...
App12.controller('AppController',
    ['$rootScope', '$scope', '$state', '$translate', '$window', '$localStorage', '$timeout', 'toggleStateService', 'colors', 'browser', 'cfpLoadingBar','$http',
        function($rootScope, $scope, $state, $translate, $window, $localStorage, $timeout, toggle, colors, browser, cfpLoadingBar,$http) {
            "use strict";
            ...
            $scope.logout = function(logoutUrl) {
                var result = confirm('确认退出系统 ?');
                if (result) {
                    $http({
                        method: 'POST',
                        url: '/api/conl/login/userLoginOut',
...
App12.controller('MasonryDeckController', ['$scope', 'RouteHelpers', function ($scope, RouteHelpers) {
    'use strict';
...
App12.controller('ModalController', ['$scope', '$modal', function ($scope, $modal) {
...
App12.controller('ChartMorrisController', ['$scope', '$timeout', 'colors', function ($scope, $timeout, colors) {
...
App12.controller('AbnTestController', ['$scope', '$timeout', '$resource', function($scope, $timeout, $resource) {
...
App12.controller('NestableController', ['$scope', function($scope) {
...
App12.controller('NGGridController', ['$scope', '$http', '$timeout', function($scope, $http, $timeout) {
...
App12.controller('NGTableCtrl', NGTableCtrl);
...
App12.service('ngTableDataService', function() {
 ...
 * Initializes the notifications system
 =========================================================*/
App12.controller('NotificationController', ['$scope', function($scope){
 ...
 * panel, so .col-* element are ideal.
 =========================================================*/
App12.controller('portletsController', [ '$scope', '$timeout', '$window', function($scope, $timeout, $window) {
    'use strict';
...
App12.controller('ChartRickshawController', ['$scope', function($scope) {
    'use strict';
 ...
 * Handle sidebar collapsible elements
 =========================================================*/
App12.controller('SidebarController', ['$rootScope', '$scope', '$state', '$http', '$timeout', 'Utils',
...
App12.controller('SortableController', ['$scope', function($scope) {
    'use strict';
...
App12.controller("deviceCtrl", function($scope, $location, $http, $rootScope, $timeout, ngDialog) {
...
App12.controller('TablexEditableController', ['$scope', '$filter', '$http', 'editableOptions', 'editableThemes','$q',
 ...
 * Module: UIGridController
 =========================================================*/
App12.controller('UIGridController', ['$scope', 'uiGridConstants', '$http', function($scope, uiGridConstants, $http) {
...
App12.controller('uiSelectController', ["$scope", "$http", function($scope, $http) {
...
App12.controller('FileUploadController', ['$scope', 'FileUploader', function($scope, FileUploader) {
...
App12.controller('UserBlockController', ['$scope', function($scope) {
...
App12.controller('VectorMapController', ['$scope', function($scope) {
    'use strict';
...
App12.controller('WordCloudController', ['$scope', function ($scope) {
...
App12.directive("animateEnabled", ["$animate", function ($animate) {
    return {
        link: function (scope, element, attrs) {
...
App12.directive("chartjs",       function () { return ChartJS(); });
App12.directive("linechart",     function () { return ChartJS("Line"); });
App12.directive("barchart",      function () { return ChartJS("Bar"); });
App12.directive("radarchart",    function () { return ChartJS("Radar"); });
App12.directive("polarchart",    function () { return ChartJS("PolarArea"); });
App12.directive("piechart",      function () { return ChartJS("Pie"); });
App12.directive("doughnutchart", function () { return ChartJS("Doughnut"); });
App12.directive("donutchart",    function () { return ChartJS("Doughnut"); });
...
App12.directive('classyloader', ["$timeout", "Utils", function($timeout, Utils) {
    'use strict';
...
App12.directive('resetKey',  ['$state','$rootScope', function($state, $rootScope) {
    'use strict';
...
App12.directive('filestyle', function() {
    return {
        restrict: 'A',
        controller: ["$scope", "$element", function($scope, $element) {
...
App12.directive('flatdoc', ['$location', function($location) {
    return {
        restrict: "EA",
...
App12.directive('flot', ['$http', '$timeout', function($http, $timeout) {
    'use strict';
    return {
        restrict: 'EA',
        template: '<div></div>',
...
App12.directive('formWizard', ["$parse", function($parse){
    'use strict';
...
App12.directive('toggleFullscreen', function() {
    'use strict';
...
App12.directive('loadCss', function() {
    'use strict';
...
App12.directive('masked', function() {
    return {
        restrict: 'A',
        controller: ["$scope", "$element", function($scope, $element) {
            var $elem = $($element);
...
(function() {
    ...
    App12.directive('morrisBar',   morrisChart('Bar')   );
    App12.directive('morrisDonut', morrisChart('Donut') );
    App12.directive('morrisLine',  morrisChart('Line')  );
    App12.directive('morrisArea',  morrisChart('Area')  );
...
App12.directive('searchOpen', ['navSearch', function(navSearch) {
    'use strict';
...
App12.directive('notify', ["$window", "Notify", function($window, Notify){
...
App12.directive("now", ['dateFilter', '$interval', function(dateFilter, $interval){
    return {
        restrict: 'E',
        link: function(scope, element, attrs){
...
App12.directive('paneltool', ["$compile", "$timeout", function($compile, $timeout){
    var templates = {
...
App12.directive('animate', ["$window", "Utils", function($window, Utils){
...
App12.directive('scrollable', function(){
    return {
        restrict: 'EA',
        link: function(scope, elem, attrs) {
...
App12.directive('sidebar', ['$rootScope', '$window', 'Utils', function($rootScope, $window, Utils) {
...
App12.directive('skycon', function(){
...
App12.directive('sparkline', ['$timeout', '$window', function($timeout, $window){
...
App12.directive('checkAll', function() {
    'use strict';
...
App12.directive('tagsinput', ["$timeout", function($timeout) {
    return {
        restrict: 'A',
        require: 'ngModel',
...
App12.directive('toggleState', ['toggleStateService', function(toggle) {
    'use strict';
...
App12.directive("triggerResize", ['$window', '$timeout', function ($window, $timeout) {
    return {
        restrict: 'A',
        link: function (scope, element, attrs) {
            element.on('click', function(){
...
App12.directive('validateForm', function() {
    return {
        restrict: 'A',
        controller: ["$scope", "$element", function($scope, $element) {
            var $elem = $($element);
...
App12.directive('vectorMap', ['vectorMap', function(vectorMap){
    'use strict';
...
App12.directive('emmsSingleDatepicker', function() {
    ...
    return {
        ...
        template: '\
            <div>\
                <p class="input-group">\
                    <input type="text" datepicker-popup="yyyy-MM-dd" ng-model="date" is-open="opened" datepicker-options="dateOptions" min-date="minDate" ng-required="true" close-text="Close" class="form-control" ng-change="transformDate()"/>\
                    <span class="input-group-btn">\
                         <button type="button" ng-click="open($event)" class="btn btn-default"><em class="fa fa-calendar"></em></button>\
                    </span>\
                </p>\
            </div>\
        ',
        ...
        controller: function($scope, $filter) {
            ...
            $scope.toggleMin = function() {
                $scope.minDate = $scope.minTime ? $scope.minTime : null;
                $scope.date = $scope.dateValue ? $scope.dateValue : today;
                //赋值到页面
                $scope.dateValue = $filter('date')($scope.date, 'yyyy-MM-dd');
                //$scope.minDate = $scope.minDate ? null : new Date();
            };
...
App12.service('browser', function(){
    "use strict";
...
App12.factory('colors', ['APP_COLORS', function(colors) {
...
App12.service('navSearch', function() {
...
App12.service('Notify', ["$timeout", function($timeout){
    this.alert = alert;
...
App12.provider('RouteHelpers', ['APP_REQUIRES', function (appRequires) {
    "use strict";
...
App12.service('toggleStateService', ['$rootScope', function($rootScope) {
...
App12.service('Utils', ["$window", "APP_MEDIAQUERY", function($window, APP_MEDIAQUERY) {
    'use strict';
...
App12.service('vectorMap', function() {
    'use strict';
    return {
