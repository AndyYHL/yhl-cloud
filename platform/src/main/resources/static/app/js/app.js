...
function ($stateProvider, $locationProvider, $urlRouterProvider, helper) {
  ...
  $stateProvider
    .state('app', {
        ...
        resolve: helper.resolveFor('fastclick', 'modernizr', 'icons', 'screenfull', 'animo', 'sparklines', 'slimscroll', 'classyloader', 'toaster', 'whirl','jquery-ui', 'jquery-ui-widgets')
    })
    .state('app.dashboard', {
        url: '/dashboard',
        title: 'Dashboard',
...
/**=========================================================
 * Module: emmsSingleDatepicker
 * Init jQuery
 =========================================================*/
App.directive('emmsSingleDatepicker', function() {
