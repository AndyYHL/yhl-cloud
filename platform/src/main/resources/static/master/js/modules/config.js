...
App1.config(['$stateProvider', '$locationProvider', '$urlRouterProvider', 'RouteHelpersProvider',
function ($stateProvider, $locationProvider, $urlRouterProvider, helper) {
  ...
  $stateProvider
    ...
    function ( $controllerProvider, $compileProvider, $filterProvider, $provide) {
      ...
      App1.controller = $controllerProvider.register;
      App1.directive  = $compileProvider.directive;
      App1.filter     = $filterProvider.register;
      App1.factory    = $provide.factory;
      App1.service    = $provide.service;
      App1.constant   = $provide.constant;
      App1.value      = $provide.value;
