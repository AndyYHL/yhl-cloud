 ...
 * Provides a simple demo for pagination
 ...
 App1.controller('MailboxController', ["$scope", "colors", function($scope, colors) {
...
App1.controller('MailFolderController', ['$scope', 'mails', '$stateParams', function($scope, mails, $stateParams) {
  // no filter for inbox
...
App1.controller('MailViewController', ['$scope', 'mails', '$stateParams', function($scope, mails, $stateParams) {
...
App1.factory('mails', ['$http', function ($http) {
