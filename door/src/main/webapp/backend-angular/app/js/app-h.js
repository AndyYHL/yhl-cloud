...
AppH.run(["$rootScope", "$state", "$stateParams",  '$window', '$templateCache', function ($rootScope, $state, $stateParams, $window, $templateCache) {
...
AppH.config(['$stateProvider', '$locationProvider', '$urlRouterProvider', 'RouteHelpersProvider',
function ($stateProvider, $locationProvider, $urlRouterProvider, helper) {
  ...
  $stateProvider
    ...
    function ( $controllerProvider, $compileProvider, $filterProvider, $provide) {
      ...
      AppH.controller = $controllerProvider.register;
      AppH.directive  = $compileProvider.directive;
      AppH.filter     = $filterProvider.register;
      AppH.factory    = $provide.factory;
      AppH.service    = $provide.service;
      AppH.constant   = $provide.constant;
      AppH.value      = $provide.value;
...
AppH.controller('LoginFormController', ['$scope', '$http', '$state', function($scope, $http, $state) {
...
AppH.controller('RegisterFormController', ['$scope', '$http', '$state', function($scope, $http, $state) {
...
AppH.controller('AngularGridController', ['$scope', '$http', function ($scope, $http) {
    'use strict';
...
AppH.controller('ArticleController', ['$scope', function ($scope) {
 ...
 */
AppH.filter('propsFilter', function() {
...
AppH.controller('CalendarController', ['$scope', function($scope) {
  'use strict';
...
AppH.controller('AngularCarouselController', ["$scope", function($scope) {
...
AppH.controller('ChartJSController', ["$scope", "colors", function($scope, colors) {
...
AppH.controller('ChartistController', ['$scope', function ($scope) {
  'use strict';
...
AppH.controller('CodeEditorController', ['$scope', '$http', '$ocLazyLoad', function ($scope, $http, $ocLazyLoad) {
...
AppH.controller('DataTableController', ['$scope', '$resource', 'DTOptionsBuilder', 'DTColumnDefBuilder',
...
AppH.controller('AlertDemoCtrl', ['$scope', function AlertDemoCtrl($scope) {
...
AppH.controller('CarouselDemoCtrl', ['$scope', function ($scope) {
...
AppH.controller('DatepickerDemoCtrl', ['$scope', function ($scope) {
...
AppH.controller('DialogIntroCtrl', ['$scope', 'ngDialog', 'tpl', function($scope, ngDialog, tpl) {
  'user strict';
...
// Loads from view
AppH.controller('DialogMainCtrl', ["$scope", "$rootScope", "ngDialog", function ($scope, $rootScope, ngDialog) {
  'user strict';
...
AppH.controller('InsideCtrl', ["$scope", "ngDialog", function ($scope, ngDialog) {
  'user strict';
  $scope.dialogModel = {
...
AppH.controller('SecondModalCtrl', ["$scope", "ngDialog", function ($scope, ngDialog) {
  'user strict';
...
AppH.controller('FormDemoCtrl', ["$scope", "$resource", function($scope, $resource) {
  'use strict';
...
AppH.controller('NotifyDemoCtrl', ['$scope', 'Notify', '$timeout', function AlertDemoCtrl($scope, Notify, $timeout) {
...
AppH.controller('PaginationDemoCtrl', ['$scope', function ($scope) {
  $scope.totalItems = 64;
  $scope.currentPage = 4;
...
AppH.controller('PanelsCtrl', ['$scope', '$timeout', function ($scope, $timeout) {
...
AppH.controller('PopoverDemoCtrl', ['$scope', function ($scope) {
...
AppH.controller('ProgressDemoCtrl', ['$scope', function ($scope) {
...
AppH.controller('RatingDemoCtrl', ['$scope', function ($scope) {
...
AppH.controller('TimepickerDemoCtrl', ['$scope', function ($scope) {
...
AppH.controller('ToasterDemoCtrl', ['$scope', 'toaster', function($scope, toaster) {
...
AppH.controller('TypeaheadCtrl', ['$scope', '$http', function ($scope, $http) {
...
AppH.controller('FlotChartController', ['$scope', 'ChartData', '$timeout', function($scope, ChartData, $timeout) {
  'use strict';
 ...
 * Image crop controller
 =========================================================*/
AppH.controller('ImageCropController', ["$scope", function($scope) {
...
AppH.controller('FormValidationController', ["$scope", function ($scope) {
  'use strict';
...
AppH.controller('FormxEditableController', ['$scope', 'editableOptions', 'editableThemes', '$filter', '$http',
...
AppH.controller('ModalGmapController', ['$scope', '$modal', '$timeout', function ($scope, $modal, $timeout) {
...
AppH.controller('GMapController', ["$scope", "$timeout", function($scope, $timeout){
...
AppH.controller('InfiniteScrollController', ["$scope", "$timeout", function($scope, $timeout) {
...
AppH.controller('LocalizationController', ["$rootScope", "tmhDynamicLocale", "$locale", function($rootScope, tmhDynamicLocale, $locale) {
 ...
 * Provides a simple demo for pagination
 ...
 AppH.controller('MailboxController', ["$scope", "colors", function($scope, colors) {
...
AppH.controller('MailFolderController', ['$scope', 'mails', '$stateParams', function($scope, mails, $stateParams) {
  // no filter for inbox
...
AppH.controller('MailViewController', ['$scope', 'mails', '$stateParams', function($scope, mails, $stateParams) {
...
AppH.factory('mails', ['$http', function ($http) {
...
AppH.controller('MasonryDeckController', ['$scope', 'RouteHelpers', function ($scope, RouteHelpers) {
  'use strict';
...
AppH.controller('ModalController', ['$scope', '$modal', function ($scope, $modal) {
...
AppH.controller('ChartMorrisController', ['$scope', '$timeout', 'colors', function ($scope, $timeout, colors) {
...
AppH.controller('AbnTestController', ['$scope', '$timeout', '$resource', function($scope, $timeout, $resource) {
...
AppH.controller('NestableController', ['$scope', function($scope) {
...
AppH.controller('NGGridController', ['$scope', '$http', '$timeout', function($scope, $http, $timeout) {
...
AppH.controller('NGTableCtrl', NGTableCtrl);
...
AppH.service('ngTableDataService', function() {
 ...
 * Initializes the notifications system
 =========================================================*/
AppH.controller('NotificationController', ['$scope', function($scope){
 ...
 * panel, so .col-* element are ideal.
 =========================================================*/
AppH.controller('portletsController', [ '$scope', '$timeout', '$window', function($scope, $timeout, $window) {
  'use strict';
...
AppH.controller('ChartRickshawController', ['$scope', function($scope) {
  'use strict';
...
AppH.controller('SidebarController', ['$rootScope', '$scope', '$state', '$http', '$timeout', 'Utils',
...
AppH.controller('SortableController', ['$scope', function($scope) {
  'use strict';
...
AppH.controller('TablexEditableController', ['$scope', '$filter', '$http', 'editableOptions', 'editableThemes','$q',
...
AppH.controller("TodoController", ['$scope', '$filter', function($scope, $filter) {
 ...
 * Module: UIGridController
  =========================================================*/
AppH.controller('UIGridController', ['$scope', 'uiGridConstants', '$http', function($scope, uiGridConstants, $http) {
...
AppH.controller('uiSelectController', ["$scope", "$http", function($scope, $http) {
...
AppH.controller('FileUploadController', ['$scope', 'FileUploader', function($scope, FileUploader) {
...
AppH.controller('UserBlockController', ['$scope', function($scope) {
...
AppH.controller('VectorMapController', ['$scope', function($scope) {
  'use strict';
...
AppH.controller('WordCloudController', ['$scope', function ($scope) {
...
AppH.directive("animateEnabled", ["$animate", function ($animate) {
  return {
    link: function (scope, element, attrs) {
...
AppH.directive("chartjs",       function () { return ChartJS(); });
AppH.directive("linechart",     function () { return ChartJS("Line"); });
AppH.directive("barchart",      function () { return ChartJS("Bar"); });
AppH.directive("radarchart",    function () { return ChartJS("Radar"); });
AppH.directive("polarchart",    function () { return ChartJS("PolarArea"); });
AppH.directive("piechart",      function () { return ChartJS("Pie"); });
AppH.directive("doughnutchart", function () { return ChartJS("Doughnut"); });
AppH.directive("donutchart",    function () { return ChartJS("Doughnut"); });
...
AppH.directive('classyloader', ["$timeout", "Utils", function($timeout, Utils) {
  'use strict';
...
AppH.directive('resetKey',  ['$state','$rootScope', function($state, $rootScope) {
  'use strict';
...
AppH.directive('filestyle', function() {
  return {
    restrict: 'A',
    controller: ["$scope", "$element", function($scope, $element) {
...
AppH.directive('flatdoc', ['$location', function($location) {
  return {
    restrict: "EA",
...
AppH.directive('flot', ['$http', '$timeout', function($http, $timeout) {
  'use strict';
  return {
    restrict: 'EA',
    template: '<div></div>',
...
AppH.directive('formWizard', ["$parse", function($parse){
  'use strict';
...
AppH.directive('toggleFullscreen', function() {
  'use strict';
...
AppH.directive('loadCss', function() {
  'use strict';
...
AppH.directive('masked', function() {
  return {
    restrict: 'A',
    controller: ["$scope", "$element", function($scope, $element) {
      var $elem = $($element);
...
(function() {
    ...
    AppH.directive('morrisBar',   morrisChart('Bar')   );
    AppH.directive('morrisDonut', morrisChart('Donut') );
    AppH.directive('morrisLine',  morrisChart('Line')  );
    AppH.directive('morrisArea',  morrisChart('Area')  );
...
AppH.directive('searchOpen', ['navSearch', function(navSearch) {
  'use strict';
...
AppH.directive('notify', ["$window", "Notify", function($window, Notify){
...
AppH.directive("now", ['dateFilter', '$interval', function(dateFilter, $interval){
    return {
      restrict: 'E',
      link: function(scope, element, attrs){
...
AppH.directive('paneltool', ["$compile", "$timeout", function($compile, $timeout){
  var templates = {
...
AppH.directive('animate', ["$window", "Utils", function($window, Utils){
...
AppH.directive('sidebar', ['$rootScope', '$window', 'Utils', function($rootScope, $window, Utils) {
...
AppH.directive('skycon', function(){
...
AppH.directive('sparkline', ['$timeout', '$window', function($timeout, $window){
...
AppH.directive('checkAll', function() {
  'use strict';
...
AppH.directive('tagsinput', ["$timeout", function($timeout) {
  return {
    restrict: 'A',
    require: 'ngModel',
...
AppH.directive('toggleState', ['toggleStateService', function(toggle) {
  'use strict';
...
AppH.directive("triggerResize", ['$window', '$timeout', function ($window, $timeout) {
  return {
    restrict: 'A',
    link: function (scope, element, attrs) {
      element.on('click', function(){
...
AppH.directive('validateForm', function() {
  return {
    restrict: 'A',
    controller: ["$scope", "$element", function($scope, $element) {
      var $elem = $($element);
...
AppH.directive('vectorMap', ['vectorMap', function(vectorMap){
  'use strict';
...
AppH.factory('colors', ['APP_COLORS', function(colors) {
...
AppH.service('navSearch', function() {
...
AppH.service('Notify', ["$timeout", function($timeout){
    this.alert = alert;
...
AppH.provider('RouteHelpers', ['APP_REQUIRES', function (appRequires) {
  "use strict";
...
AppH.service('toggleStateService', ['$rootScope', function($rootScope) {
...
AppH.service('Utils', ["$window", "APP_MEDIAQUERY", function($window, APP_MEDIAQUERY) {
    'use strict';
...
AppH.service('vectorMap', function() {
  'use strict';
  return {
